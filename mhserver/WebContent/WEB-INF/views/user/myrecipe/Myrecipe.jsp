...
<body>
	...
	<fieldset>
		...
		<c:forEach items="${bestList }" var="dto">
			<div id="bestimgset1">
				<a href="http://localhost:8090/mh/user/myrecipe/myrecipedetail.do?seq=${dto.seq}">
	...
	<c:forEach items="${list }" var="dto">
			<div class="nomalRcpimg">
				<a href="http://localhost:8090/mh/user/myrecipe/myrecipedetail.do?seq=${dto.seq}"> <img src="/mh/images/${dto.img}" class="bestimg" /></a>
				<div class="foodType">${dto.category}</div>
				<a href="http://localhost:8090/mh/user/myrecipe/myrecipedetail.do?seq=${dto.seq}">
						<div class="bestContents">${dto.title}</div>
				</a>
