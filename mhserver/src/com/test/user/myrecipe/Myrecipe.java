...
public class Myrecipe extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (n == 1) {
			...
			pagebar += "<li>";
			pagebar += String.format("<a href=\"/mh/user/myrecipe/myrecipelist.do?page=%d\" aria-label=\"Previous\">", n - 1);
			pagebar += "<span aria-hidden=\"true\">&laquo;</span>";
			pagebar += "</a>";
			pagebar += "</li>";
		}
		...
		while (!(loop > blockSize || n > totalPage)) {
			...
			if (n == nowPage) {
				...
				pagebar += "<li>";
				pagebar += String.format("<a href=\"/mh/user/myrecipe/myrecipelist.do?page=%d\">%d</a>", n, n);
				pagebar += "</li>";
			}
		...
		if (n > totalPage) {
			...
			pagebar += "<li>";
			pagebar += String.format("<a href=\"/mh/user/myrecipe/myrecipelist.do?page=%d\" aria-label=\"Next\">", n);
			pagebar += "<span aria-hidden=\"true\">&raquo;</span>";
			pagebar += "</a>";
			pagebar += "</li>";
		}
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/user/myrecipe/myrecipelist.jsp");
